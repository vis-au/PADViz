...
export default class Spaghetti2 extends Component {
    ...
    createSpaghetti() {
        ...
        const svg = d3.select(".Spaghetti2")
                .attr("width", width + margin.left + margin.right)
                .attr("height", height + margin.top + margin.bottom)
            .append("g")
                .attr("transform", "translate(" + margin.left + "," + margin.top + ")");
       
        d3.json("/json/line?type=s6").then(function(data){
